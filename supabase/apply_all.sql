-- =============================================================================
-- apply_all.sql — convenience bundle: paste this whole file into the Supabase
-- SQL Editor (Dashboard → SQL Editor → New query → paste → Run) to set up the
-- entire database in one shot: schema + RLS + storage/auth + demo seed data.
